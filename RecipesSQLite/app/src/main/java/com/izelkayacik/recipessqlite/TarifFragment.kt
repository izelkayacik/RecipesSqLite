package com.izelkayacik.recipessqlite
        ...
        if (secilenBitmap != null)
        {
            ...
            try {
                context?.let {
                    ...
                    database.execSQL("CREATE TABLE IF NOT EXISTS yemekler (id INTEGER PRIMARY KEY, yemekismi VARCHAR, yemekmalzemelesi VARCHAR, gorsel BLOB)")
